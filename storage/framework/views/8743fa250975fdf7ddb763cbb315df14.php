...
<body>
    ...
    <div class="header-left">
        <img src="<?php echo e(asset('img/STOCKING.png')); ?>" alt="StocKING" class="logo-header">
    </div>
    
    <div class="header-right">
        <div class="search-bar">
            <input type="text" class="search-input" placeholder="Search">
            <img src="<?php echo e(asset('img/Search.png')); ?>" class="search-icon">
        </div>
        
        <div class="header-icons">
            <img src="<?php echo e(asset('img/Notifikasi.png')); ?>" alt="Notif" class="notif-icon">
    ...
    <div class="sidebar">
        <div class="brand-logo">
            <img src="<?php echo e(asset('img/STOCKING.png')); ?>" alt="Logo StocKING">
        </div>
    
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="menu-item active">
            <img src="<?php echo e(asset('img/Home.png')); ?>" alt="Home"> Dashboard
        </a>

        <a href="<?php echo e(route('admin.inventaris')); ?>" class="menu-item">
            <img src="<?php echo e(asset('img/Inventoris.png')); ?>" alt="Inventaris"> Inventaris
        </a>

        <div class="sidebar-bottom">
            <a href="<?php echo e(route('admin.pengaturan')); ?>" class="menu-item" style="color: #595959; background: transparent;">
                <img src="<?php echo e(asset('img/Settings.png')); ?>" alt="Pengaturan"> Pengaturan
            </a>
            <a href="#" class="menu-item" style="color: rgba(89,89,89,0.5); background: transparent;" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                <img src="<?php echo e(asset('img/Logout.png')); ?>" alt="Logout"> Log Out
            </a>
        </div>
    </div>
    ...
    <div class="main-content">
        <div class="top-header">
            <div class="search-bar">
                ...
                <img src="<?php echo e(asset('img/Search.png')); ?>" alt="Search">
            </div>
            
            <div class="header-icons">
                <img src="<?php echo e(asset('img/Notifikasi.png')); ?>" alt="Notifikasi" class="notif-icon">
        ...
        <div class="dashboard-body">
            ...
            <div class="dashboard-subtitle">Hallo, <?php echo e(ucfirst(auth()->user()->username ?? 'Admin StocKING')); ?></div>
            ...
            <div class="report-date">
                Laporan Periode <?php echo e($tanggalMulai); ?> s/d <?php echo e($tanggalAkhir); ?>
            ...
            <div class="col-md-3">
                <div class="summary-card-container">
                    ...
                    <div class="card-top-layer">
                        ...
                        <h3><?php echo e($totalTransaksi); ?> Penjualan</h3>
                        <img src="<?php echo e(asset('img/Grafik.png')); ?>" alt="Grafik">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="summary-card-container">
                    ...
                    <div class="card-top-layer">
                        <h6>Pemasukan</h6>
                        <h3>Rp <?php echo e(number_format($totalPemasukan, 0, ',', '.')); ?></h3>
                        <img src="<?php echo e(asset('img/Grafik.png')); ?>" alt="Grafik">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="summary-card-container">
                    ...
                    <div class="card-top-layer">
                        ...
                        <h3><?php echo e($totalBahan); ?></h3>
                        <img src="<?php echo e(asset('img/Package.png')); ?>" alt="Package">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="summary-card-container">
                    ...
                    <div class="card-top-layer">
                        ...
                        <img src="<?php echo e(asset('img/Warning.png')); ?>" alt="Warning">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="transaction-section">
                ...
                <?php if(count($transaksiTerbaru) > 0): ?>
                    <div style="max-height: 270px; overflow-y: auto; overflow-x: hidden; border-radius: 10px;">
                        <table class="table table-borderless" style="margin-bottom:0;">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $transaksiTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <?php
                                        ...
                                        <td>Rp <?php echo e(number_format($d->harga_satuan ?? 0, 0, ',', '.')); ?></td>
                                        <td><?php echo e($d->jumlah ?? 0); ?></td>
                                        <td>Rp <?php echo e(number_format(($d->harga_satuan ?? 0) * ($d->jumlah ?? 0), 0, ',', '.')); ?></td>
                                        <td>Rp <?php echo e(number_format(optional($d->transaksi)->total_harga ?? 0, 0, ',', '.')); ?></td>
                                        <td><?php echo e(ucfirst(optional($d->transaksi)->metode_pembayaran ?? '-')); ?></td>
                                    </tr>
                ...
                <?php else: ?>
                    <div class="empty-state">
                        <img src="<?php echo e(asset('img/Frown.png')); ?>" alt="Frown">
...
</html><?php /**PATH C:\xampp\htdocs\stocking\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>