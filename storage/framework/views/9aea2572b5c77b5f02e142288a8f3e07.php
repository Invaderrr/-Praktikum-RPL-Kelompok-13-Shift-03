...
<aside class="w-64 border-r border-[#E0E0E0] flex flex-col bg-white">
    ...
    <nav class="flex-1 px-4 mt-4 space-y-2">
        <a href="<?php echo e(route('user.belanja')); ?>" class="flex items-center px-4 py-2 rounded-lg font-semibold text-black shadow-sm" 
            style="background: linear-gradient(93.69deg, rgba(219, 212, 0, 0.5) 0.99%, rgba(245, 158, 11, 0.5) 100%);">
            <img alt="Belanja Icon" class="w-5 h-5 mr-3" src="<?php echo e(asset('img/Belanja.png')); ?>"/> <span class="text-sm">Belanja</span>
        </a>
        
        <a href="<?php echo e(route('user.transaksi')); ?>" class="flex items-center px-4 py-2 text-[#828282] hover:bg-gray-50 rounded-lg transition-all">
            <img alt="Transaksi Icon" class="w-5 h-5 mr-3 opacity-60" src="<?php echo e(asset('img/Dollar.png')); ?>"/> 
                ...
                <div class="grid grid-cols-3 gap-6">
                    ...
                    <div class="layer-bottom">
                        <div class="layer-top flex justify-between items-start">
                            <div>
                                <h6 class="font-bold text-sm"><?php echo e($p->nama_item ?? $p->nama_bahan); ?></h6>
                                <p class="text-[10px] text-gray-400"><?php echo e($p->kategori); ?></p>
                                <p class="text-orange-500 font-bold text-sm mt-1">Rp <?php echo e(number_format($p->harga, 0, ',', '.')); ?></p>
                                <p class="text-[10px] text-gray-500">Stok: <?php echo e($p->stok); ?> <?php echo e($p->satuan); ?></p>
                            </div>
                            
                        
                            <button type="button"
                            onclick="addToCart('<?php echo e($p->getKey()); ?>', '<?php echo e(addslashes($p->nama_item ?? $p->nama_bahan)); ?>', '<?php echo e($p->harga); ?>', '<?php echo e($p->stok); ?>')" 
...
<script>
    ...
    async function sendDataToServer(metode, alamat) {
        try {
            ...
            const response = await fetch("<?php echo e(route('user.checkout.proses')); ?>", {
                method: "POST",
                headers: {
            ...
            if (response.ok && result.success) {
                ...
                window.location.href = "<?php echo e(route('user.transaksi')); ?>"; 
            } else {
...
</html><?php /**PATH C:\xampp\htdocs\stocking\resources\views/user/belanja.blade.php ENDPATH**/ ?>