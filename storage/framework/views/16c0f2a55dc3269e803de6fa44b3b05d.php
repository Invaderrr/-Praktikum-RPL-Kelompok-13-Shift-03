...
/* Terapkan animasi ke kartu login/register */
    ...
    <div class="login-card">
        <img src="<?php echo e(asset('img/STOCKING.png')); ?>" alt="StocKING" class="logo-img">
        ...
        <form action="<?php echo e(route('register')); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="password-wrapper">
                    ...
                    <img src="<?php echo e(asset('img/Icon-eye.png')); ?>" class="icon-eye toggle-pass" data-target="password">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="password-wrapper">
                    ...
                    <img src="<?php echo e(asset('img/Icon-eye.png')); ?>" class="icon-eye toggle-pass" data-target="confirm_password">
                </div>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\stocking\resources\views/user/register.blade.php ENDPATH**/ ?>