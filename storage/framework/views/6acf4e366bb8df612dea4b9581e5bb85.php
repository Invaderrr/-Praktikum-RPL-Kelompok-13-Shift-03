...
<aside class="w-64 border-r border-stocking-border flex flex-col bg-white">
    <div class="p-6">
        <h1 class="text-2xl font-bold italic tracking-tighter">
            <img alt="STOCKING Logo" class="h-8" src="<?php echo e(asset('img/STOCKING.png')); ?>"/>
        </h1>
    </div>
    <nav class="flex-1 px-4 mt-4 space-y-2">
        <a href="<?php echo e(url('/admin/dashboard')); ?>" 
           class="flex items-center px-4 py-2 rounded-lg font-semibold transition-all duration-200 
           <?php echo e(request()->routeIs('admin.dashboard') ? 'text-black shadow-sm' : 'text-[#828282] hover:text-black hover:bg-gray-50'); ?>"
           style="<?php echo e(request()->routeIs('admin.dashboard') ? 'background: linear-gradient(93.69deg, rgba(219, 212, 0, 0.5) 0.99%, rgba(245, 158, 11, 0.5) 100%);' : ''); ?>">
            <img alt="Home Icon" class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('admin.dashboard') ? 'brightness-0' : 'opacity-60 grayscale'); ?>" src="<?php echo e(asset('img/Home.png')); ?>"/>
            <span class="text-sm">Dashboard</span>
        </a>

        <a href="<?php echo e(route('admin.inventaris')); ?>" 
            class="flex items-center px-4 py-2 rounded-lg font-semibold transition-all duration-200 
            <?php echo e(request()->routeIs('admin.inventaris') ? 'text-black shadow-sm' : 'text-gray-500 hover:text-black'); ?>"
            style="<?php echo e(request()->routeIs('admin.inventaris') ? 'background: linear-gradient(93.69deg, rgba(219, 212, 0, 0.5) 0.99%, rgba(245, 158, 11, 0.5) 100%);' : 'background: transparent;'); ?>">
            <img alt="Inventaris Icon" class="w-5 h-5 mr-3 <?php echo e(request()->routeIs('admin.inventaris') ? 'brightness-0' : 'opacity-60 grayscale'); ?>" src="<?php echo e(asset('img/Inventoris.png')); ?>"/> 
            <span class="text-sm">Inventaris</span>
        </a>
    </nav>
    <div class="p-4 space-y-2">
        <a class="flex items-center px-4 py-2 text-[#828282] hover:bg-gray-50 rounded-lg transition-colors" href="<?php echo e(route('admin.pengaturan')); ?>">
            <img alt="Settings Icon" class="w-5 h-5 mr-3" src="<?php echo e(asset('img/Settings.png')); ?>"/>
            <span class="text-sm font-medium">Pengaturan</span>
        </a>
        <a class="flex items-center px-4 py-2 text-[#828282] hover:bg-gray-50 rounded-lg transition-colors" href="#">
            <img alt="Logout Icon" class="w-5 h-5 mr-3" src="<?php echo e(asset('img/Logout.png')); ?>"/>
        ...
        <div class="flex-1 max-w-md">
            <div class="relative">
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                    <img alt="Search Icon" class="w-4 h-4" src="<?php echo e(asset('img/Search.png')); ?>"/>
                </div>
            </div>
        </div>
        <div class="flex items-center space-x-6">
            <button class="relative">
                <img alt="Notification Icon" class="w-6 h-6" src="<?php echo e(asset('img/Notifikasi.png')); ?>"/>
            </button>
            ...
            <div class="relative inline-block w-64">
                ...
                <div x-show="open" x-transition style="background-color: #ECEDED; border: 1px solid #0000004D;" class="absolute z-50 w-full mt-1 rounded-md shadow-lg overflow-hidden">
                    <ul class="py-1 text-[#151515]">
                        <?php $__currentLoopData = ['Semua Kategori', 'Bahan Kering', 'Bumbu', 'Nabati', 'Hewani', 'Bahan Masak', 'Frozen Food', 'Instan', 'Minuman']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <button @click="selected = '<?php echo e($kat); ?>'; open = false" type="button" class="w-full text-left px-4 py-2 hover:bg-[#D1D2D2] transition-colors"><?php echo e($kat); ?></button>
                        </li>
            ...
            <div class="overflow-x-auto table-container">
                <table class="w-full text-left border-separate border-spacing-0"> 
                    ...
                    <tbody style="color: #1D1D1D; font-size: 16px;" class="font-medium">
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors" data-kategori="<?php echo e($item->kategori); ?>">
                            <td class="py-4 px-6">
                                <input type="checkbox" class="custom-checkbox item-checkbox" value="<?php echo e($item->id_bahan_baku); ?>"/>
                            </td>
                            <td class="py-4 px-6"><?php echo e($item->nama_bahan); ?></td>
                            <td class="py-4 px-6"><?php echo e($item->stok); ?></td>
                            <td class="py-4 px-6">
                                <?php echo e($item->kategori); ?>

                            </td>
                            <td class="py-4 px-6"><?php echo e($item->satuan); ?></td>
                            <td class="py-4 px-6">Rp. <?php echo e(number_format($item->harga, 0, ',', '.')); ?></td>
                        </tr>
        ...
        <form id="editForm" method="POST" class="space-y-4">
            ...
            <div data-purpose="form-group">
                ...
                <select id="edit_kategori" name="kategori" class="w-full p-3 bg-[#F9F9F9] border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-yellow-400" required>
                    <?php $__currentLoopData = ['Bahan Kering', 'Bumbu', 'Nabati', 'Hewani', 'Bahan Masak', 'Frozen Food', 'Instan', 'Minuman']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div x-show="openModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40" x-transition x-cloak>
    <div class="bg-white w-full max-w-2xl rounded-2xl shadow-2xl p-8 relative mx-4" @click.away="openModal = false">
        ...
        <form action="<?php echo e(route('admin.inventaris.store')); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>
            <div data-purpose="form-group">
...
</html><?php /**PATH C:\xampp\htdocs\stocking\resources\views/admin/inventaris.blade.php ENDPATH**/ ?>