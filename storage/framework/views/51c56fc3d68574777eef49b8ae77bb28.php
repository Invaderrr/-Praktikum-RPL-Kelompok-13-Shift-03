...
<head>
    ...
    <style>
        ...
        /* Lingkaran Profil - Presisi Desain */
        .profile-circle {
            width: 150px;
            height: 150px;
            background-color: #00DBFF; /* Warna Cyan khas Stocking */
            border-radius: 50%;
            cursor: pointer;
        ...
        /* Styling Input - Disamakan dengan Inventaris (#F9F9F9) */
        .field-input {
        ...
        .field-input:focus { border: 1px solid #F2C94C !important; ring: 0 !important; }
    </style>
</head>
...
<aside class="w-64 border-r border-stocking-border flex flex-col bg-white">
    ...
    <nav class="flex-1 px-4 mt-4 space-y-2">
        ...
        <a href="<?php echo e(route('admin.inventaris')); ?>" 
           class="flex items-center px-4 py-2 rounded-lg font-semibold transition-all duration-200 
           <?php echo e(request()->routeIs('admin.inventaris') ? 'text-black shadow-sm' : 'text-[#828282] hover:text-black hover:bg-gray-50'); ?>"
           style="<?php echo e(request()->routeIs('admin.inventaris') ? 'background: linear-gradient(93.69deg, rgba(219, 212, 0, 0.5) 0.99%, rgba(245, 158, 11, 0.5) 100%);' : ''); ?>">
    ...
    <div class="p-4 space-y-2 border-t border-gray-50">
        <a href="<?php echo e(route('admin.pengaturan')); ?>" 
           ...
           style="background: linear-gradient(93.69deg, rgba(219, 212, 0, 0.5) 0.99%, rgba(245, 158, 11, 0.5) 100%);">
            <img alt="Settings Icon" class="w-5 h-5 mr-3 brightness-0" src="<?php echo e(asset('img/Settings.png')); ?>"/>
...
<div class="flex-1 flex flex-col overflow-hidden">
    <header class="h-16 border-b border-stocking-border bg-white flex items-center justify-between px-8">
        <div class="flex-1 max-w-md">
            <div class="relative">
                <input class="w-full pl-4 pr-10 py-1.5 border border-stocking-border rounded-lg text-sm outline-none focus:border-stocking-yellow" placeholder="Search" type="text"/>
...
</html><?php /**PATH C:\xampp\htdocs\stocking\resources\views/admin/pengaturan.blade.php ENDPATH**/ ?>