...
<body class="flex h-screen overflow-hidden">
    ...
    <aside class="w-64 border-r border-gray-200 flex flex-col bg-[#FFFFFF] h-full">
        ...
        <nav class="flex-1 px-4 mt-4 space-y-2">
            <a href="<?php echo e(route('user.belanja')); ?>" class="flex items-center px-4 py-2 text-[#828282] hover:bg-gray-50 rounded-lg transition-colors">
                <img alt="Belanja Icon" class="w-5 h-5 mr-3 opacity-60" src="<?php echo e(asset('img/Belanja.png')); ?>"/> 
                <span class="text-sm font-medium">Belanja</span>
            </a>

            <a href="<?php echo e(route('user.transaksi')); ?>" 
               ...
               style="background: linear-gradient(93.69deg, rgba(219, 212, 0, 0.5) 0.99%, rgba(245, 158, 11, 0.5) 100%);"> 
                <img alt="Transaksi Icon" class="w-5 h-5 mr-3 brightness-0" src="<?php echo e(asset('img/Dollar.png')); ?>"/>
        ...
        <div class="p-4 space-y-2">
            <a class="flex items-center px-4 py-2 text-[#828282] hover:bg-gray-50 rounded-lg transition-colors" href="#">
                <img alt="Settings Icon" class="w-5 h-5 mr-3 opacity-60" src="<?php echo e(asset('img/Settings.png')); ?>"/>
            ...
            <form action="<?php echo e(route('logout')); ?>" method="POST">
                ...
                <button type="submit" class="w-full flex items-center px-4 py-2 text-[#828282] hover:bg-gray-50 rounded-lg transition-colors font-semibold">
                    <img alt="Logout Icon" class="w-5 h-5 mr-3 opacity-60 grayscale" src="<?php echo e(asset('img/Logout.png')); ?>"/>
            ...
            <div class="flex gap-x-6">
                <div class="summary-card-container">
                    ...
                    <div class="card-top-layer">
                        ...
                        <h3><?php echo e($riwayat->count()); ?> Pembelian</h3>
                ...
                <div class="summary-card-container">
                    ...
                    <div class="card-top-layer">
                        <h6>Total Biaya</h6>
                        <h3>Rp <?php echo e(number_format($riwayat->sum('total_harga'), 0, ',', '.')); ?></h3>
                        <img src="<?php echo e(asset('img/Grafik.png')); ?>" alt="Grafik">
                    </div>
                </div>
            </div>
            ...
            <div class="transaction-section">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="text-sm text-gray-700">
                        <?php $__empty_1 = true; $__currentLoopData = $riwayat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php $__currentLoopData = $t->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-3">
                                    <?php if($index === 0): ?>
                                        <div class="font-bold"><?php echo e($t->tanggal_transaksi->format('d M Y')); ?></div>
                                        <?php
                                            $jam = $t->jam_transaksi;
                                            $jamTxt = $jam ? \Carbon\Carbon::parse($jam)->format('H:i') : ($t->tanggal_transaksi ? $t->tanggal_transaksi->format('H.i') : '-');
                                        ?>
                                        <div class="text-[10px] text-gray-400"><?php echo e($jamTxt); ?> WIB</div>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-3"><?php echo e($detail->nama_item ?? $detail->bahanBaku->nama_bahan ?? '-'); ?></td>
                                <td class="px-6 py-3">Rp <?php echo e(number_format($detail->harga_satuan, 0, ',', '.')); ?></td>
                                <td class="px-6 py-3"><?php echo e($detail->jumlah); ?></td>
                                <td class="px-6 py-3">Rp <?php echo e(number_format($detail->harga_satuan * $detail->jumlah, 0, ',', '.')); ?></td>
                                <td class="px-6 py-3">
                                    <?php if($index === 0): ?>
                                ...
                                <?php if($index == 0): ?>
                                    <?php echo e(ucfirst($t->metode_pembayaran)); ?>
...
</html><?php /**PATH C:\xampp\htdocs\stocking\resources\views/user/transaksi.blade.php ENDPATH**/ ?>